...
public class PersonalityPersonaPromptTemplate {
     ...
     */
    private static final Map<PersonaType, String> DEFAULT_PROMPT_MAP = new EnumMap<>(PersonaType.class);
    ...
    public static String getPersonalityPromptToPersona(PersonaType type) {
